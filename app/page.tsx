  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 pt-20 pb-12 grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <div className="mt-6 flex gap-3">
            ...
            <a href="mailto:you@example.com" className="px-4 py-2 rounded-lg bg-black text-white">Hire Me</a>
          </div>
        </div>
        ...
        <ul className="space-y-4">
          <li className="rounded-2xl border p-5">
            <div className="flex justify-between">
              ...
              <span className="text-sm text-gray-600">Jan – Jun 2025</span>
            </div>
            <p className="mt-2 text-sm text-gray-700">
              Built monitoring dashboards and tooling for Polygon & Ethereum Pectra upgrades.
              Worked with Agile (Jira), GitHub, and Bitbucket.
            </p>
          </li>
        </ul>
      </Section>
      ...
      <footer className="border-t">
        <div className="mx-auto max-w-6xl p-4 text-sm text-gray-600 text-center">
          © {new Date().getFullYear()} Niroshan Sivarajah · Built with Next.js & Tailwind
        </div>
      </footer>
    </>
  );
